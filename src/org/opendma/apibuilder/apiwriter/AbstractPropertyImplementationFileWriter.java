...
public abstract class AbstractPropertyImplementationFileWriter
{
    ...
    protected abstract void writePropertyImplementationFileFooter(ApiDescription apiDescription, PrintWriter out) throws IOException;
    ...
    public void createPropertyFile(ApiDescription apiDescription, OutputStream propertyImplementationOutputStream) throws IOException
    {
        // create output Writer
        PrintWriter out = new PrintWriter(propertyImplementationOutputStream);
        ...
        // write Header
        writePropertyImplementationFileHeader(apiDescription,requiredImports,out);
        ...
        // write Footer
        writePropertyImplementationFileFooter(apiDescription,out);
        // close writer and streams
        out.close();
        propertyImplementationOutputStream.close();
    }
