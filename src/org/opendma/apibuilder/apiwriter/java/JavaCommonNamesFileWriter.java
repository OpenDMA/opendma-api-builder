...
public class JavaCommonNamesFileWriter extends AbstractConstantsFileWriter
{
    ...
    protected void writeConstantsClassnameConstant(ClassDescription classDescription, String constantName, PrintWriter out)
    {
        ...
        out.println("    public static final OdmaQName "+constantName+" = new OdmaQName(\""+classDescription.getOdmaName().getNamespace()+"\", \""+classDescription.getOdmaName().getName()+"\");");
    }
    ...
    protected void writeConstantsPropertynameConstant(PropertyDescription propertyDescription, String constantName, PrintWriter out)
    {
        ...
        out.println("    public static final OdmaQName "+constantName+" = new OdmaQName(\""+propertyDescription.getOdmaName().getNamespace()+"\", \""+propertyDescription.getOdmaName().getName()+"\");");
    }
