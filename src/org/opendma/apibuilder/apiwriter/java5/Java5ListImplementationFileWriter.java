...
public class Java5ListImplementationFileWriter extends AbstractListFileWriter
{
    
    protected OdmaApiWriter apiWriter;
    
    public Java5ListImplementationFileWriter(OdmaApiWriter writer)
    {
        apiWriter = writer;
    }
    ...
    protected void writeListFileHeader(ScalarTypeDescription scalarTypeDescription, List requiredImports, PrintWriter out)
    {
        ...
        while(itRequiredImports.hasNext())
        {
            ...
            if(Java5ApiWriter.needToImportPackage(importDeclaration,"org.opendma.impl.collections"))
            {
        ...
        out.println(" */");
        out.println("public class Array"+interfaceName+" extends ArrayList<"+singleValueDataType+"> implements "+interfaceName);
        out.println("{");
        out.println("");
