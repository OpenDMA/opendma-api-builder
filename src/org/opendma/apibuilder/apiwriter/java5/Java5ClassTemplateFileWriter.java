...
public class Java5ClassTemplateFileWriter extends AbstractClassFileWriter
{
    
    protected OdmaApiWriter apiWriter;
    
    public Java5ClassTemplateFileWriter(OdmaApiWriter writer)
    {
        apiWriter = writer;
    ...
    protected void writeClassFileHeader(ClassDescription classDescription, List requiredImports, PrintWriter out)
    {
        ...
        while(itRequiredImports.hasNext())
        {
            ...
            if(Java5ApiWriter.needToImportPackage(importDeclaration,"org.opendma.templates"))
            {
