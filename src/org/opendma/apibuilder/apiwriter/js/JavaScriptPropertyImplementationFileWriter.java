...
public class JavaScriptPropertyImplementationFileWriter extends AbstractPropertyFileWriter
{
    
    protected OdmaApiWriter apiWriter;
    
    public JavaScriptPropertyImplementationFileWriter(OdmaApiWriter writer)
    {
        apiWriter = writer;
    }
    ...
    protected void writeGenericSectionSwitch(ApiDescription apiDescription, PrintWriter out, boolean multivalue) throws IOException
    {
        ...
        out.println("            switch(this._dataType) {");
