...
public class TypeScriptCommonNamesFileWriter extends AbstractConstantsFileWriter
{
    protected void writeConstantsFileHeader(ApiDescription apiDescription, PrintWriter out)
    {
        out.println("import { OdmaQName } from './OdmaQName';");
        out.println("");
        out.println("// Static declaration of all common names used in the OpenDMA specification.");
        out.println("export const OdmaCommonNames = Object.freeze({");
    }
    ...
    protected void writeConstantsClassnameConstant(ClassDescription classDescription, String constantName, PrintWriter out)
    {
        ...
        out.println("    "+constantName+": new OdmaQName(\""+classDescription.getOdmaName().getNamespace()+"\", \""+classDescription.getOdmaName().getName()+"\"),");
    }
    ...
    protected void writeConstantsPropertynameConstant(PropertyDescription propertyDescription, String constantName, PrintWriter out)
    {
        ...
        out.println("    "+constantName+": new OdmaQName(\""+propertyDescription.getOdmaName().getNamespace()+"\", \""+propertyDescription.getOdmaName().getName()+"\"),");
    }
