...
public class CsPropertyImplementationFileWriter extends AbstractPropertyFileWriter
{
    ...
    protected void writeSingleValueScalarAccess(ScalarTypeDescription scalarTypeDescription, PrintWriter out) throws IOException
    {
        ...
        if(scalarTypeDescription.isReference())
		{
	        ...
	        out.println("                {");
	        out.println("                    if(_value != null)");
            out.println("                    {");
            out.println("                        if (_value is IOdmaObject odmaObject)");
            out.println("                        {");
            out.println("                             return odmaObject.Id;");
            out.println("                        }");
            out.println("                        else");
            out.println("                        {");
            out.println("                            throw new OdmaException(\"Internal error. Reference value is expected to be instance of OdmaObject\");");
            out.println("                        }");
            out.println("                    }");
            out.println("                    else");
            out.println("                    {");
