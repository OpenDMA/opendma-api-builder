...
OdmaProperty piString = new OdmaProperty(qn, "hello", null, OdmaType.STRING, false, false);
OdmaProperty piInteger = new OdmaProperty(qn, 123, null, OdmaType.INTEGER, false, false);
OdmaProperty piDouble = new OdmaProperty(qn, 1.23, null, OdmaType.DOUBLE, false, false);
OdmaProperty piDate = new OdmaProperty(qn, new DateTime(), null, OdmaType.DATETIME, false, false);
...
piString.Value = null;
Console.WriteLine(piString.Value);
OdmaProperty piStringRO = new OdmaProperty(qn, "hello", null, OdmaType.STRING, false, true);
...
OdmaProperty piStringMV = new OdmaProperty(qn, new List<string>(), null, OdmaType.STRING, true, false);
